    ...
    <div class="row">
            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/amazon.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/apple.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/google.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/airbnb.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/facebook.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{Vite::asset('resources/images/companies/cisco.png')}}" alt="logo" class="avatar-xl rounded-circle mb-3">
