    ...
    <div class="row">
        <div class="col-lg-4 col-xl-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="{{Vite::asset('resources/images/users/user-1.jpg')}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="timeline">
                            ...
                            <div class="border border-light p-2 mb-3">
                                ...
                                <img src="{{Vite::asset('resources/images/small/img-1.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{Vite::asset('resources/images/small/img-2.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{Vite::asset('resources/images/small/img-3.jpg')}}" alt="post-img" class="rounded" height="60" />
