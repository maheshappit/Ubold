                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                                <span class="badge badge-soft-warning float-end">Cold lead</span>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                                <span class="badge badge-soft-warning float-end">Cold lead</span>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" width="40" alt="Generic placeholder image">
                            <div class="w-100">
                                <span class="badge badge-soft-success float-end">Won lead</span>
