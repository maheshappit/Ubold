...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Stripe</a></li>
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Today Conference  Status</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6" style="flex: 0 0 auto; margin-left:-15px">
                                <div class="text">
                                    <h3 class="text-dark my-1"><span data-plugin="counterup">50</span></h3>
                                    <p class="text-muted mb-1 text-truncate" style="overflow:visible;margin-left: -2rem ">Collected Data</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                            <h6 class="text-uppercase">Collected Data <span class="float-end">60%</span></h6>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6" style="flex: 0 0 auto; margin-left:-15px">
                                <div class="text">
                                    <h3 class="text-dark my-1"><span data-plugin="counterup">25</span></h3>
                                    <p class="text-muted mb-1 text-truncate" style="overflow:visible;margin-left: -2rem">Email Sent</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                            <h6 class="text-uppercase">Email Sent <span class="float-end">49%</span></h6>
                            <div class="progress progress-sm m-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6" style="flex: 0 0 auto; margin-left:-15px">
                                <div class="text">
                                    <h3 class="text-dark my-1"><span data-plugin="counterup">25</span></h3>
                                    <p class="mb-1" style="overflow:visible;margin-left: -2rem">Email Pending</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                            <h6 class="text-uppercase">Email Pending<span class="float-end">18%</span></h6>
                            <div class="progress progress-sm m-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6" style="flex: 0 0 auto; margin-left:-15px">
                                <div class="text">
                                    ...
                                    <p class="mb-1 "style="overflow:visible;margin-left: -2rem">Total No of Tasks</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
                            <h6 class="text-uppercase">Total No of Tasks <span class="float-end">74%</span></h6>
                            <div class="progress progress-sm m-0">
        ...
        <!-- end row -->
        <h4 class="page-title" style="color:white; margin: 21px 21px 21px 0px; font-size: 25px;">Today Mail  Status</h4>
        <div class="row">
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
        ...
        <h4 class="page-title" style="color:white; margin: 21px 21px 21px 0px; font-size: 25px;">Lead Pipelines</h4>
        <div class="row">
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
