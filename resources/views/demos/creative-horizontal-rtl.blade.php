@extends('layouts.horizontal', ['page_title' => 'Creative RTL (Horizontal Layout)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'creative', 'rtl' => $rtl ?? 'rtl'])

@section('css')
    <link href="{{ Vite::asset('node_modules/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />
@endsection
