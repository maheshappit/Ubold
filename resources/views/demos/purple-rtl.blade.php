@extends('layouts.vertical', ['page_title' => 'Purple RTL (Dashboard)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'purple', 'topbar' => $topbar ?? 'brand', 'rtl' => $rtl ?? 'rtl'])

@section('css')
    <link href="{{ Vite::asset('node_modules/flatpickr/dist/flatpickr.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
