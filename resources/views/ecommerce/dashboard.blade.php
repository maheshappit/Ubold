                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ms-2">Imelda J. Stanberry</span>
                                        </td>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/cards/visa.png') }}" alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ms-2">Francisca S. Lobb</span>
                                        </td>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/cards/master.png') }}" alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ms-2">James A. Wert</span>
                                        </td>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/cards/amazon.png') }}" alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ms-2">Dolores J. Pooley</span>
                                        </td>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/cards/american-express.png') }}" alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ms-2">Karen I. McCluskey</span>
                                        </td>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/cards/discover.png') }}" alt="user-card" height="24" />
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/products/product-1.png') }}" alt="product-pic" height="36" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/products/product-2.png') }}" alt="product-pic" height="36" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/products/product-3.png') }}" alt="product-pic" height="36" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/products/product-4.png') }}" alt="product-pic" height="36" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ Vite::asset('resources/images/products/product-5.png') }}" alt="product-pic" height="36" />
