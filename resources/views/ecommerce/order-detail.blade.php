                        ...
                        <table class="table table-bordered table-centered mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="{{Vite::asset('resources/images/products/product-1.png')}}" alt="product-img" height="32"></td>
                                    <td>1</td>
                                    <td>$39</td>
                                    <td>$39</td>
                                </tr>
                                <tr>
                                    ...
                                    <td><img src="{{Vite::asset('resources/images/products/product-5.png')}}" alt="product-img" height="32"></td>
                                    <td>2</td>
                                    <td>$46</td>
                                    <td>$92</td>
                                </tr>
                                <tr>
                                    <th scope="row">Red Hoodie for men</th>
                                    <td><img src="{{Vite::asset('resources/images/products/product-3.png')}}" alt="product-img" height="32"></td>
                                    <td>1</td>
                                    <td>$46</td>
                                    <td>$46</td>
                                </tr>
