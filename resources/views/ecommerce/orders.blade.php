                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-1.png')}}" alt="product-img" height="32" /></a>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-2.png')}}" alt="product-img" height="32" /></a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-3.png')}}" alt="product-img" height="32" /></a>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-4.png')}}" alt="product-img" height="32" /></a>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-5.png')}}" alt="product-img" height="32" /></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-7.png')}}" alt="product-img" height="32" /></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-3.png')}}" alt="product-img" height="32" /></a>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-8.png')}}" alt="product-img" height="32" /></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-4.png')}}" alt="product-img" height="32" /></a>
                                        <a href="{{route('second', ['ecommerce', 'product-detail'])}}"><img src="{{Vite::asset('resources/images/products/product-6.png')}}" alt="product-img" height="32" /></a>
                                    </td>
