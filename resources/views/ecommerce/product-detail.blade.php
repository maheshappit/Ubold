                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="tab-content pt-0">
                                    <div class="tab-pane active show" id="product-1-item">
                                        <img src="{{ Vite::asset('resources/images/products/product-9.jpg') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                    </div>
                                    <div class="tab-pane" id="product-2-item">
                                        <img src="{{ Vite::asset('resources/images/products/product-10.jpg') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                    </div>
                                    <div class="tab-pane" id="product-3-item">
                                        <img src="{{ Vite::asset('resources/images/products/product-11.jpg') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                    </div>
                                    <div class="tab-pane" id="product-4-item">
                                        <img src="{{ Vite::asset('resources/images/products/product-12.jpg') }}" alt="" class="img-fluid mx-auto d-block rounded">
                                    </div>
                                </div>
