                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="search-item">
                                            <div class="d-flex align-items-start">
                                                <img class="d-flex me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="Generic placeholder image" height="54">
                                                <div class="w-100">
                                                    <h5 class="mt-0">
                                        ...
                                        <div class="search-item">
                                            ...
                                            <div class="">
                                                <img src="{{ Vite::asset('resources/images/small/img-1.jpg') }}" height="48" alt="image" />
                                                <img src="{{ Vite::asset('resources/images/small/img-2.jpg') }}" height="48" alt="image" />
                                                <img src="{{ Vite::asset('resources/images/small/img-3.jpg') }}" height="48" alt="image" />
                                                <img src="{{ Vite::asset('resources/images/small/img-4.jpg') }}" height="48" alt="image" />
                                            </div>
                                        </div> <!-- end search item -->
                            ...
                            <div class="tab-pane" id="users">
                                ...
                                <div class="search-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" alt="Generic placeholder image" height="54">
                                        <div class="w-100">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="Generic placeholder image" height="54">
                                        <div class="w-100">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" alt="Generic placeholder image" height="54">
                                        <div class="w-100">
                                            <h5 class="mt-0">
                                ...
                                <div class="search-item">
                                    <div class="d-flex align-items-start">
                                        <img class="d-flex me-3 rounded-circle" src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="Generic placeholder image" height="54">
                                        <div class="w-100">
                                            <h5 class="mt-0">
