                            ...
                            <div class="timeline-box">
                                ...
                                <div class="timeline-album">
                                    <a href="javascript: void(0);">
                                        <img alt="" src="{{ Vite::asset('resources/images/small/img-1.jpg') }}">
                                    </a>
                                    <a href="javascript: void(0);">
                                        <img alt="" src="{{ Vite::asset('resources/images/small/img-2.jpg') }}">
                                    </a>
                                    <a href="javascript: void(0);">
                                        <img alt="" src="{{ Vite::asset('resources/images/small/img-3.jpg') }}">
                                    </a>
                                </div>
                            </div>
                        </div>
