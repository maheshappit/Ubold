                            ...
                            <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);" class="text-body">
                                                <img src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                        ...
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{ Vite::asset('resources/images/users/user-10.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);" class="text-body">
                                                <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                        ...
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{ Vite::asset('resources/images/users/user-9.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);" class="text-body">
                                                <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);" class="text-body">
                                                <img src="{{ Vite::asset('resources/images/users/user-8.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);">
                                                <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript: void(0);" class="text-body">
                                                <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-xs" />
