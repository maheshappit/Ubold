        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <img class="card-img-bottom img-fluid" src="{{ Vite::asset('resources/images/small/img-6.jpg') }}" alt="Card image cap">
                </div> <!-- end card-->
            </div> <!-- end col -->
            <div class="col-md-4">
                <div class="card card-inverse text-white">
                    <img class="card-img img-fluid" src="{{ Vite::asset('resources/images/small/img-7.jpg') }}" alt="Card image">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row row-cols-1 row-cols-md-3 g-3">
                    <div class="col">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="{{ Vite::asset('resources/images/small/img-7.jpg') }}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card">
                            <img class="card-img img-fluid" src="{{ Vite::asset('resources/images/small/img-2.jpg') }}" alt="Card image cap">
                        </div>
